...
const contactInfo = [];
graduates.forEach(function (list){
 contactInfo.push(list.first_name +' '+ list.email);
});
...
let uni = [];
graduates.includes(function uni (items){
...
zooAnimals.forEach(function (list){
 animalNames.push('Name: ' + list.animal_name + ', Scientific '+ list.scientific_name);
});
...
let lowerCase = [];
lowerCase = zooAnimals.map (function name(list){
...
*/
let lowerPopulation = [];
lowerPopulation = zooAnimals.filter(function low (items){
